({
    ...
    handleSubmit : function(component, event, helper) {
        ...
        eventFields["Rate_Per_Sq_Ft__c"] = component.get('v.ratePerSqFeet');
        eventFields["Plot_Size__c"] = component.get('v.plotSize');
        eventFields["Basic_Price__c"] = component.get('v.basicprice');
